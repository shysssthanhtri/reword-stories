...
The application SHALL accept `sourceLanguage` as one of: `ko`, `ja`, `zh`, `other`. Labels displayed in the UI SHALL be **Korean**, **Japanese**, **Chinese**, and **Other** respectively. Validation SHALL be enforced in shared Zod schemas used by both tRPC and forms.
